...
func (a *RepositoriesApiService) RepositoriesUsernameRepoSlugHooksPost(ctx context.Context, username string, repoSlug string) (WebhookSubscription,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
